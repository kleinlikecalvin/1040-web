  ...
  return (
    <form className="App">
      ...
      <fieldset>
        ...
        <input type="number" id="amount-overpaid" />
        <label htmlFor="line-34-refund-amount">
          35a Amount of line 34 you want refunded to you.
        </label>
        <input type="number" id="line-34-refund-amount" />{" "}
        <input type="checkbox" id="8888-attached" />
